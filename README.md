...
`privacy.html` y `support.html` se sirven en
`https://jrverdes.github.io/nextrace-data/…` y están enlazadas desde la app y
desde App Store Connect. No cambies sus nombres.
